<template>
    <div ref="wrapperRef" class="custom-multiselect">
        ...
        <div
            class="custom-multiselect-content relative w-full rounded-lg border border-gray-300 hover:border-gray-600 focus:border-2 focus:border-primary bg-white transition-all duration-200"
            :class="{
            ...
            >
                ...
                <div class="flex items-center gap-1 ml-auto pl-1 shrink-0 self-center">
                    <button
                        ...
                        type="button"
                        tabindex="-1"
                        class="w-5 h-5 rounded-full hover:bg-gray-100 text-gray-400 hover:text-gray-800 transition-all flex items-center justify-center"
                        @click.stop="clearAll"
                    >
