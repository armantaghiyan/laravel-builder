...
class BuilderPublishCommand extends Command {
	...
	public function handle(): void {
		...
		$this->addPackageDependency("@vitejs/plugin-vue", "^6.0.8", "devDependencies");
		$this->addPackageDependency("concurrently", "^10.0.5", "devDependencies");
		$this->addPackageDependency("laravel-vite-plugin", "^3.2.0", "devDependencies");
		$this->addPackageDependency("tailwindcss", "^4.2.4", "devDependencies");
		$this->addPackageDependency("typescript", "^6.0.3", "devDependencies");
		$this->addPackageDependency("vite", "^8.3.0", "devDependencies");
		$this->addPackageDependency("vue-tsc", "^3.3.11", "devDependencies");
		$this->addPackageDependency( "axios", "^1.20.0", "devDependencies");
		...
		$this->addPackageDependency( "vue", "^3.5.41");
		$this->addPackageDependency( "vue-router", "^5.2.0");
		$this->addPackageDependency( "unplugin-vue-components", "^32.1.0");
		$this->addPackageDependency( "unplugin-auto-import", "^21.1.0");
